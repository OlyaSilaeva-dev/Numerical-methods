...
int main() {
    ...
    double result_estimation2 = runge_romberg_estimation(func, x_0, x_k, h_1, h_2, RECTANGLE);
    std::cout << "rectangle_integration_method for h2: " << result2_test << std::endl;
    std::cout << "Estimation rectangle for RECTANGLE: " << result_estimation2 << std::endl;
    ...
    double result_estimation4 = runge_romberg_estimation(func, x_0, x_k, h_1, h_2, TRAPEZOID);
    std::cout << "trapezoid_integration_method for h2: " << result4_test << std::endl;
    std::cout << "Estimation trapezoid for TRAPEZOID: " << result_estimation4 << std::endl;
    ...
    double result_estimation6 = runge_romberg_estimation(func, x_0, x_k, h_1,h_2, SIMPSON);
    std::cout << "Simpson_integration_method for h2: " << result6_test << std::endl;
    std::cout << "Estimation Simpson for SIMPSON: " << result_estimation6 << std::endl;
